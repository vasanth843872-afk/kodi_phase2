...
class FamilyAdmin(admin.ModelAdmin):
    ...
    list_display = ('family_name_2', 'created_by', 'is_locked', 'created_at', 'members_count')
    list_filter = ('is_locked', 'created_at')
    search_fields = ('family_name_2', 'created_by__mobile_number')
    readonly_fields = ('created_at', 'updated_at')
    fieldsets = (
        ('Family Information', {
            'fields': ('family_name_2', 'description', 'is_locked')
        }),
        ('Creator', {
            'fields': ('created_by',)
        }),
...
class FamilyInvitationAdmin(admin.ModelAdmin):
    ...
    search_fields = ('family__family_name_2', 'inviter__mobile_number', 'invitee_mobile')
