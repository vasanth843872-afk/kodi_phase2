...
#         ('Auto-Filters', {
#             'fields': (
#                 'enable_lifestyle_filter',
#                 'enable_family_filter', 'enable_location_filter',
#                 'enable_connection_filter'
#             )
#         }),
#         ('Block Lists', {
#             'fields': ('blocked_lifestyles', 'blocked_families', 'blocked_locations')
#         }),
#         ('Moderation', {
...
#         ('Visibility', {
#             'fields': (
#                 'visibility', 'target_lifestyles', 'target_families', 'target_locations', 'invited_users',
