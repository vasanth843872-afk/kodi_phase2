...
#         ('Visibility Criteria', {
#             'fields': (
#                 'lifestyle_criteria', 'lifestyle_criteria',
#                 'family_name_2_criteria', 'area_criteria'
#             ),
...
#         if obj.lifestyle_criteria:
#             criteria.append(f'lifestyle: {len(obj.lifestyle_criteria)} values')
#         if obj.family_name_2_criteria:
#             criteria.append(f'Family: {len(obj.family_name_2_criteria)} values')
