...
class PostVisibilityRuleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'description', 'lifestyle_criteria', 'lifestyle_criteria',
            'family_name_2_criteria', 'area_criteria', 'is_active',
    ...
    def validate(self, data):
        ...
        criteria_fields = ['lifestyle_criteria', 'lifestyle_criteria', 'family_name_2_criteria', 'area_criteria']
        has_criteria = any(
        ...
        if not has_criteria:
            raise serializers.ValidationError(
                "At least one criterion (lifestyle, lifestyle, family_name_2, or area) must be specified."
            )
...
class PostVisibilityRuleCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PostVisibilityRule
        fields = [
            'name', 'description', 'lifestyle_criteria', 'lifestyle_criteria',
            'family_name_2_criteria', 'area_criteria', 'is_active'
        ]
